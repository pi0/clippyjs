export default {
  ...
  framesize: [124, 93],
  tts: { rate: 0.8, pitch: 0.5, voice: "Google UK English Male" },
  animations: {
    DeepIdle1: {
      frames: [
    ...
    Idle1_1: {
      frames: [
        ...
        { duration: 0, branching: { branches: [{ frameIndex: 94, weight: 65 }] }, exitBranch: 94 },
        ...
        { duration: 0, branching: { branches: [{ frameIndex: 94, weight: 70 }] }, exitBranch: 94 },
